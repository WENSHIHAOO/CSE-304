...
Code Generator: decaf_codegen.py — Generate code definitions

Abstract Machines: decaf_absmc.py — Definition of abstract machines and operational abstract programs. Used to print machine code.
